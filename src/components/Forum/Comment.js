...
import { getCommentData, commentOnComment, deleteCommentInLiveThread } from "../../firebase/forum";
...
const Comment = (props) => {
  ...
  const onCommentSubmit = async (data) => {
    ...
    const [newCommentId, newCommentData] = await commentOnComment(props.cid, data.comment);
  ...
  return (
    ...
    >
      ...
      { commentData.deleted &&
        <Typography variant="body2" sx={{ mx: 2, mb: 1, fontStyle: 'italic' }}>[deleted]</Typography>
      }
